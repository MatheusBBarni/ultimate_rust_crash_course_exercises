...
const BULLSEYE_POINTS: i32 = 5;
const HIT_POINTS_CRITICAL: i32 = 2;
const HIT_POINTS_NORMAL: i32 = 1;
const MISS_POINTS: i32 = 0;
...
impl Shot {
    ...
    fn points(self) -> i32 {
        ...
        match self {
            Shot::Bullseye => BULLSEYE_POINTS,
            Shot::Miss => MISS_POINTS,
            Shot::Hit(value) if value < 3.0 => HIT_POINTS_CRITICAL,
            Shot::Hit(value) => HIT_POINTS_NORMAL,
        }
    }
}
...
fn main() {
    ...
    for coord in arrow_coords {
        ...
        let shot = match distance_from_center {
            value if value >= 1.0 && value <= 5.0 => Shot::Hit(distance_from_center),
            value if value > 5.0 => Shot::Miss,
            value => Shot::Hit(distance_from_center),
        };
        shots.push(shot);
    }
